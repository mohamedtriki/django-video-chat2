...
#         action=recive_dict['action']
#         if (action == 'new-offer') or (action =='new-answer'):
#             receiver_channel_name = recive_dict['message']['receiver_channel_name']
#             recive_dict['message']['receiver_channel_name']= self.channel_name
#             await self.channel_layer.send(
#             receiver_channel_name,
#             {
#                 'type':'send.sdp',
#                 'recive_dict':recive_dict,
#             }
#         )
#             return
...
#         recive_dict = event['recive_dict']

#         await self.send(text_data=json.dumps(recive_dict))
